...
\begin{figure}[b]
\vspace{-5mm}        
        \centering{\includegraphics[width=0.4\columnwidth]{single.pdf}}
         \vspace{0.1mm}
...
\begin{figure}
\vspace{-5mm}        
          %% \centering{\includegraphics[width=0.9\textwidth]{multi.pdf}}
          \centering{\includegraphics[width=0.3\textwidth]{img/tad-bad.png}}
          \centering{\includegraphics[width=0.3\textwidth]{img/cup-cut.png}}
...
\begin{figure}[ht]
\vspace{-3mm}        
        \centering{\includegraphics[width=0.4\columnwidth]{activefail.pdf}}
...
\begin{figure}[tb]
\vspace{-5mm}        
        \centering{\includegraphics[width=\columnwidth]{features.pdf}}
